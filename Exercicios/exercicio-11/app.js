...
*/
    ...
    const formatDate = date => {
        const day = formatTImeUnit(dateExample.getDate())
        const month = formatTImeUnit[dateExample.getMonth() + 1]
        const year = dateExample.getFullYear()
        
        return `${day}/${month}/${year}`
    }

    console.log(formatDate(dateExample));
...
const { id, isVerified } = user //destructuring
...
//Quando a propriedade criada e a varialvel atribuida é igual usa-se o shorthand property names, para nao ficar redundante 
