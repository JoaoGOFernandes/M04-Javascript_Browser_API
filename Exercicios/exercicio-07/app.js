...
*/
    ...
    //SETTIMEOUT INTEIRO SIMPLIFICADO
    // setTimeout(message=>{
    //     console.log('Um segundo e meio se passaram desde que a página foi carregada')
    // }, 1500, )

    //SETTIMEOUT RECEBENDO MAIS UM PARAMETRO
    // setTimeout(message=>{
    //     console.log(message)
    // }, 1500, 'Um segundo e meio se passaram desde que a página foi carregada')   //Message vai receber a mensagem especificada no ultimo paramentro
    
    //SETTIMEOUT DESACOPLADO
    ...
    //SETTIMEOUT MINIMALISTA
    setTimeout(console.log, 1500, message)      //message vai ser passado como parametro do log
...
*/
    ...
    const btnIinit = document.querySelector('.button-init-counter')
    ...
    btnIinit.addEventListener('click', () => {
