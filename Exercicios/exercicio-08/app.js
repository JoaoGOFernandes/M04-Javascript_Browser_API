...
const countNumbersLessThan501 = (accumutalor, number) => 
    crazyNumbers < 501 ? ++accumutalor : accumutalor
...
// const movieBefore2000s = tarantinoMovies.filter(movie => movie.release < 2000)
const movieBefore2000s = tarantinoMovies.filter(({release}) => release < 2000)

console.log(movieBefore2000s);
/*
  06
...
const showNames = tvShows.map(({name}) => name) //Destruction da tv show
