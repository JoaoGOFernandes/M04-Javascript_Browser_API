...
// elementsInsideDiv.forEach(element => {
//   element.addEventListener('click', event => {
//     const clickedElementTagName = event.target.tagName.toLowerCase()

//     console.log(`Clicou no ${clickedElementTagName} da div.`)
//     event.stopPropagation()
//   })
// })
...
*/
  ...
  elementsInsideDiv.forEach(element => {
      element.addEventListener('click', event => {
        ...
        h2.textContent = `Clicou no ${clickedElementTagName} da div.`
        event.stopPropagation()
      })
    })
