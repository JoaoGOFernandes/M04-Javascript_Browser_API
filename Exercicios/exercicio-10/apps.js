...
const months = [
 ...
 console.log(present.getFullYear());
  /*
    ...
    - Exiba o objeto no console.
  */
  const past = new Date("November 11 2001 16:00:00")
  console.log(past);
  /*
    05
  ...
  */
  ...
  /*
    ...
    - Exiba o objeto no console.
  */
 const future = new Date('January 19 2023 00:01:00')
 console.log(future);
  ...
  */
  ...
  console.log(difference + " milisegundos");
  console.log(Math.round(difference/1000/60/60/60/24) + " dias" );
  /*
    08
